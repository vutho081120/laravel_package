...
<header class="navbar navbar-expand-sm navbar-light d-print-none">
    <div class="container-xl">
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="#">
                <img src="{{ asset('vendor/post/images/Admin/logo.svg') }}" width="110" height="32" alt="Tabler"
        ...
        <div class="navbar-nav flex-row order-md-last">
            <div class="d-none d-md-flex">
                <a href="{{-- route('site.account.logout') --}}" class="nav-link px-0" aria-label="Logout" data-bs-toggle="tooltip"
                    data-bs-placement="bottom" data-bs-original-title="Logout">
